...
```
curl https://github.com/vizionelkhelp/vizion.ai/blob/master/beat-install-scripts/install-config-mongodb.sh > install-config-mongodb.sh; chmod a+x  install-config-mongodb.sh; ./install-config-mongodb.sh _PLACEHOLDER_API_ENDPOINT_
```
...
5) Choose the ```MongoDB``` module and click OK.
